...
void	run_test_ft_strncpy()
{
	...
	char			dst_ft1[20] = {0};
	char			dst_ref1[20] = {0};
	char			*ret_ft1 = ft_strncpy(dst_ft1, src1,);
	char			*ret_ref1 = strncpy(dst_ref1, src1,);
	...
	char	dst_ft2[20] = {0};
	char	dst_ref2[20] = {0};
	char			*ret_ft2 = ft_strncpy(dst_ft2, src2,);
	char			*ret_ref2 = strncpy(dst_ref2, src2,);
	...
	char	dst_ft3[40] = {0};
	char	dst_ref3[40] = {0};
	char			*ret_ft3 = ft_strncpy(dst_ft3, src3,);
	char			*ret_ref3 = strncpy(dst_ref3, src3,);
	...
	char			dst_ft4[40] = {0};
	char			dst_ref4[40] = {0};
	char			*ret_ft4 = ft_strncpy(dst_ft4, src4,);
	char			*ret_ref4 = strncpy(dst_ref4, src4,);
	...
	char			dst_ft5[40] = {0};
	char			dst_ref5[40] = {0};
	char			*ret_ft5 = ft_strncpy(dst_ft5, src5,);
	char			*ret_ref5 = strncpy(dst_ref5, src5,);
	...
	char			*ret_ft6 = ft_strncpy(dst_ft6, src6,);
	char			*ret_ref6 = strncpy(dst_ref6, src6,);
